...
export const LIMITS = {
  ...
  overall_notice: { minChars: 35, chars: 50, lines: 3, label: "Overall 気づいたこと" },
  observation_good: { minChars: 50, chars: 70, lines: 4, label: "Observation①" },
  observation_concern: { minChars: 50, chars: 70, lines: 4, label: "Observation②" },
  observation_reason: { minChars: 50, chars: 70, lines: 4, label: "Observation③" },
  prescription_first: { minChars: 50, chars: 70, lines: 4, label: "Prescription①" },
  prescription_next: { minChars: 50, chars: 70, lines: 4, label: "Prescription②" },
  prescription_advanced: { minChars: 50, chars: 70, lines: 4, label: "Prescription③" },
  key_phrase: { minChars: 150, chars: 220, lines: 4, label: "Key Phrase" },
